...
const AdminNavber = (props) => {
  ...
  return (
    <Fragment>
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full" style={{background:"#2F4F4F"}}>
        {/*  Large Screen Show  */}
        ...
        <div className="hidden lg:block">
          <span
            ...
            className="flex items-left text-center font-bold uppercase text-white text-2xl cursor-pointer px-2 text-center"
          >
            Hey, ADMIN!! Welcome to your Dashboard
          </span>
        </div>
